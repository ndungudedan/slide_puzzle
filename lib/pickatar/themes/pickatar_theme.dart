...
import 'package:very_good_slide_puzzle/pickatar/layout/pickatar_puzzle_layout_delegate.dart';
import 'package:very_good_slide_puzzle/theme/theme.dart';

/// {@template dashatar_theme}
/// The dashatar puzzle theme.
/// {@endtemplate}
abstract class PickatarTheme extends PuzzleTheme {
  /// {@macro dashatar_theme}
  const PickatarTheme() : super();

  @override
  String get name => 'Pickatar';
  ...
  ///
  /// This asset is shown in the Pickatar theme picker.
  String get themeAsset;

  /// The path to the success image asset of this theme.
  ///
  /// This asset is shown in the success state of the Pickatar puzzle.
