...
/// {@endtemplate}
class PickatarShareYourScore extends StatelessWidget {
  /// {@macro dashatar_share_your_score}
  const PickatarShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final PickatarShareDialogEnterAnimation animation;
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Row(
                  ...
                  children: const [
                    PickatarTwitterButton(),
                    Gap(16),
                    PickatarFacebookButton(),
                  ],
                ),
              ),
            ),
