...
/// {@endtemplate}
class PickatarTwitterButton extends StatelessWidget {
  /// {@macro dashatar_twitter_button}
  const PickatarTwitterButton({Key? key}) : super(key: key);
...
/// {@endtemplate}
class PickatarFacebookButton extends StatelessWidget {
  /// {@macro dashatar_facebook_button}
  const PickatarFacebookButton({Key? key}) : super(key: key);
...
/// {@endtemplate}
@visibleForTesting
class PickatarShareButton extends StatefulWidget {
  /// {@macro dashatar_share_button}
  const PickatarShareButton({
    Key? key,
  ...
  @override
  State<PickatarShareButton> createState() => _PickatarShareButtonState();
}

class _PickatarShareButtonState extends State<PickatarShareButton> {
