...
import 'package:very_good_slide_puzzle/pickatar/widgets/pickatar_score.dart';
import 'package:very_good_slide_puzzle/pickatar/widgets/pickatar_share_dialog_animated_builder.dart';
import 'package:very_good_slide_puzzle/pickatar/widgets/pickatar_share_your_score.dart';

/// {@template dashatar_share_dialog}
/// Displays a Pickatar share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class PickatarShareDialog extends StatefulWidget {
  /// {@macro dashatar_share_dialog}
  const PickatarShareDialog({
    Key? key,
  ...
  @override
  State<PickatarShareDialog> createState() => _PickatarShareDialogState();
}

class _PickatarShareDialogState extends State<PickatarShareDialog>
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: PickatarShareDialogAnimatedBuilder(
