...
/// Displays the Pickatar theme picker to choose between
/// [PickatarThemeState.themes].
///
/// By default allows to choose between [BluePickatarTheme],
/// [GreenPickatarTheme] or [YellowPickatarTheme].
/// {@endtemplate}
class PickatarThemePicker extends StatefulWidget {
  /// {@macro dashatar_theme_picker}
  const PickatarThemePicker({
    Key? key,
  ...
  @override
  State<PickatarThemePicker> createState() => _PickatarThemePickerState();
}

class _PickatarThemePickerState extends State<PickatarThemePicker> {
  ...
  Widget build(BuildContext context) {
    final themeState = context.watch<PickatarThemeBloc>().state;
      ...
      child: ResponsiveLayoutBuilder(
        ...
        child: (currentSize) {
          ...
          final activeSize = isSmallSize
              ? PickatarThemePicker._activeThemeSmallSize
              : PickatarThemePicker._activeThemeNormalSize;
          final inactiveSize = isSmallSize
              ? PickatarThemePicker._inactiveThemeSmallSize
              : PickatarThemePicker._inactiveThemeNormalSize;
                    ...
                    child: MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          // Update the current Pickatar theme.
                          context
                              .read<PickatarThemeBloc>()
                              .add(PickatarThemeChanged(themeIndex: index));

                          // Play the audio of the current Pickatar theme.
