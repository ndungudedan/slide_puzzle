...
/// {@endtemplate}
class PickatarPuzzleActionButton extends StatefulWidget {
  /// {@macro dashatar_puzzle_action_button}
  const PickatarPuzzleActionButton({Key? key, AudioPlayerFactory? audioPlayer})
  ...
  @override
  State<PickatarPuzzleActionButton> createState() =>
      _PickatarPuzzleActionButtonState();
}

class _PickatarPuzzleActionButtonState
    extends State<PickatarPuzzleActionButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = status == PickatarPuzzleStatus.loading;
    final isStarted = status == PickatarPuzzleStatus.started;
